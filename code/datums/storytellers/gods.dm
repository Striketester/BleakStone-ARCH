/datum/storyteller/astrata
	...
	influence_sets = list(
		...
		"Set 2" = list(
			STATS_ALIVE_NOBLES = list("name" = "Number of nobles:", "points" = 3.25, "capacity" = 70),
		),
		"Set 3" = list(
		...
		"Set 5" = list(
			...
			STATS_SLURS_SPOKEN = list("name" = "Slurs spoken:", "points" = 1, "capacity" = 80),
		)
	)
...
/datum/storyteller/noc
	...
	influence_sets = list(
		...
		"Set 3" = list(
			STATS_ILLITERATES = list("name" = "Number of illiterates:", "points" = -2.25, "capacity" = -40),
		),
		"Set 4" = list(
			STATS_SKILLS_DREAMED = list("name" = "Skills dreamed:", "points" = 0.325, "capacity" = 100),
		),
		"Set 5" = list(
			STATS_MANA_SPENT = list("name" = "Mana spent:", "points" = 0.0175, "capacity" = 90),
		)
	)
...
/datum/storyteller/ravox
	...
	influence_sets = list(
		"Set 1" = list(
			STATS_COMBAT_SKILLS = list("name" = "Combat skills learned:", "points" = 1.2, "capacity" = 100),
		),
		"Set 2" = list(
...
/datum/storyteller/abyssor
	...
	influence_sets = list(
		...
		"Set 5" = list(
			...
			STATS_BATHS_TAKEN = list("name" = "Baths taken:", "points" = 2.5, "capacity" = 50),
		)
	)
...
/datum/storyteller/necra
	...
	influence_sets = list(
		...
		"Set 3" = list(
			...
			STATS_ALIVE_SNOW_ELVES = list("name" = "Pure elves:", "points" = 4, "capacity" = 50),
		),
		"Set 4" = list(
...
/datum/storyteller/pestra
	...
	influence_sets = list(
		"Set 1" = list(
			STATS_POTIONS_BREWED = list("name" = "Potions brewed:", "points" = 4.5, "capacity" = 80),
		),
		"Set 2" = list(
			STATS_WOUNDS_SEWED = list("name" = "Wounds sewed up:", "points" = 0.475, "capacity" = 100),
		),
		"Set 3" = list(
			STATS_LUX_HARVESTED = list("name" = "Lux extracted:", "points" = 7, "capacity" = 70),
...
/datum/storyteller/malum
	...
	influence_sets = list(
		"Set 1" = list(
			STATS_MASTERWORKS_FORGED = list("name" = "Masterworks forged:", "points" = 2.4, "capacity" = 85),
		),
		"Set 2" = list(
		...
		"Set 4" = list(
			...
			STATS_ALIVE_DWARVES = list("name" = "Number of dwarfs:", "points" = 4, "capacity" = 40),
		),
		"Set 5" = list(
			STATS_BLACKSTEEL_SMELTED = list("name" = "Blacksteel smelted:", "points" = 5, "capacity" = 65),
		)
	)
...
/datum/storyteller/eora
	...
	influence_sets = list(
		"Set 1" = list(
			STATS_PARENTS = list("name" = "Number of parents:", "points" = 8, "capacity" = 90),
			STATS_CHILD_POPULATION = list("name" = "Number of children:", "points" = 6, "capacity" = 70),
		),
		"Set 2" = list(
			STATS_MARRIAGES = list("name" = "Marriages made:", "points" = 25, "capacity" = 75),
			STATS_ALIVE_HARPIES = list("name" = "Number of harpies:", "points" = 6, "capacity" = 50),
		),
		"Set 3" = list(
			STATS_HUGS_MADE = list("name" = "Hugs made:", "points" = 1.75, "capacity" = 60),
		),
		"Set 4" = list(
			STATS_HANDS_HELD = list("name" = "Hands held:", "points" = 1.75, "capacity" = 60),
		),
		"Set 5" = list(
			STATS_CLINGY_PEOPLE = list("name" = "Clingy people:", "points" = 6, "capacity" = 75),
			STATS_PACIFISTS = list("name" = "Number of pacifists:", "points" = 10, "capacity" = 70),
		)
	)
...
/datum/storyteller/dendor
	...
	influence_sets = list(
		"Set 1" = list(
			...
			STATS_WEREVOLVES = list("name" = "Number of werevolves:", "points" = 15, "capacity" = 80),
		),
		"Set 2" = list(
...
/datum/storyteller/zizo
	...
	influence_sets = list(
		"Set 1" = list(
			STATS_ZIZO_PRAISED = list("name" = "Zizo praised:", "points" = 0.8, "capacity" = 40),
		),
		"Set 2" = list(
		...
		"Set 5" = list(
			STATS_TORTURES = list("name" = "Tortures performed:", "points" = 4.25, "capacity" = 70),
		)
	)
...
/datum/storyteller/baotha
	...
	influence_sets = list(
		"Set 1" = list(
			STATS_DRUGS_SNORTED = list("name" = "Drugs snorted:", "points" = 4.5, "capacity" = 85),
		),
		"Set 2" = list(
		...
		"Set 4" = list(
			...
			STATS_ALIVE_TIEFLINGS = list("name" = "Number of tieflings:", "points" = 5, "capacity" = 50),
		),
		"Set 5" = list(
...
/datum/storyteller/matthios
	...
	influence_sets = list(
		...
		"Set 2" = list(
			STATS_SHRINE_VALUE = list("name" = "Value offered to his idol:", "points" = 0.1, "capacity" = 70),
		),
		"Set 3" = list(
		...
		"Set 5" = list(
			STATS_LOCKS_PICKED = list("name" = "Locks picked:", "points" = 3.75, "capacity" = 85),
			STATS_GRAVES_ROBBED = list("name" = "Graves robbed:", "points" = 5, "capacity" = 60),
		)
	)
